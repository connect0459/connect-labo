...
@Suite("Survey - アンケートドメインモデル")
struct SurveyTests {

    // MARK: - 利用可能判定

    @Test("期限内のアンケートは回答可能")
    func 期限内は回答可能() throws {
        // Arrange
